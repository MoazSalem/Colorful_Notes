      ...
      builder: (context, state) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: C.isTablet ? 50 : 30),
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(
                      color: textColor == 0 ? Colors.white54 : Colors.black54,
                    ),
                  ),
                ),
              ),
              SizedBox(height: C.isTablet ? 40 : 10),
              Column(
                children: [
                  GestureDetector(
                    onTap: () {
                  ...
                  FittedBox(
                    child: Padding(
                      padding: EdgeInsets.symmetric(
                        horizontal: C.isTablet ? 100 : 20.0,
                      ),
                      child: SizedBox(
                        height: 65,
                        child: Center(
                        ...
                        child: SizedBox(
                          ...
                          child: Center(
                            child: ListView.builder(
                              ...
                              scrollDirection: Axis.horizontal,
                              itemCount: 5,
                              itemBuilder: (BuildContext context, index3) =>
                                  GestureDetector(
                                    onTap: () {
                                      index3 += 5;
                                      bIndex = index3;
